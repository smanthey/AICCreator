# inbound_cookies_release_guard OPERATIONS
...
## Job
- description: Enforce daily major-update commit lane for Inbound-cookies and verify webhook signature enforcement in both TS and Python paths with release-safe checks.
- primary_command: `npm run -s repo:priority:major:daily -- --only inbound-cookies`
- cron: `15 * * * *`
