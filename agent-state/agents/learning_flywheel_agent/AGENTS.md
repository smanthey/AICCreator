# learning_flywheel_agent OPERATIONS
...
## Job
- description: Run robust pattern updates and feature rotation so new patterns/libraries surface continuously in the learning lane.
- primary_command: `npm run -s pattern:robust:build && npm run -s feature:rotation:daily`
- cron: `18 */2 * * *`
