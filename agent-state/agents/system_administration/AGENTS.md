# system_administration OPERATIONS
...
## Job
- description: Run runtime and cleanup checks, monitor drift, and maintain operational baselines.
- primary_command: `npm run -s audit:runtime`
- cron: `55 * * * *`
