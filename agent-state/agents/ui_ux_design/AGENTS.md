...
## Job
- description: Run workflow walkthrough audits to detect UX friction and missing user journey coverage.
- primary_command: `npm run -s workflow:audit:soft`
- cron: `35 * * * *`
