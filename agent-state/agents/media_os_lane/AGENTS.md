...
## Job
- description: Execute the bounded Media OS chain and keep metadata/hash/visual coverage moving forward.
- primary_command: `npm run -s media:chain -- --limit 2000 --hash-limit 5000 --visual-limit 2000`
- cron: `12,42 * * * *`
