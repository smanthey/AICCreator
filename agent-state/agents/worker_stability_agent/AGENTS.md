# worker_stability_agent OPERATIONS
...
## Job
- description: Analyze PM2 logs for restart patterns, check memory leaks, monitor connection pools, investigate Ollama conflicts, implement fixes.
- primary_command: `npm run -s status:review:worker`
- cron: `*/30 * * * *`
