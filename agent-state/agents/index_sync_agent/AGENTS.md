...
## Job
- description: Run MCP health, repomap refresh, symbolic QA index sync, and readiness scoring to publish shared index knowledge for all lanes.
- primary_command: `npm run -s index:sync:agent`
- cron: `*/30 * * * *`
