# gocrawdaddy_saas_builder OPERATIONS
...
## Job
- description: Scaffold or refresh the GoCrawdaddy repo, sync research signals, and queue OpenCode implementation cycles for VPS onboarding, deploy automation, and health dashboard.
- primary_command: `npm run -s gocrawdaddy:launch`
- cron: `10 */2 * * *`
