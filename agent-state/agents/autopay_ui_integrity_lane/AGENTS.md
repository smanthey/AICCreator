# autopay_ui_integrity_lane OPERATIONS
...
## Job
- description: Enforce daily major-update commit lane for autopay_ui and close route-flow gaps, especially payment crediting and webhook auth behavior.
- primary_command: `npm run -s repo:priority:major:daily -- --only autopay_ui`
- cron: `45 * * * *`
