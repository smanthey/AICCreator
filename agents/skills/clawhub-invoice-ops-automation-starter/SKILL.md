# Invoice Ops Automation Starter Skill

## Outcome
Deliver a repeatable workflow that solves: Invoicing and ops are handled manually across spreadsheets and ad-hoc processes.

## Target Users
small_business, freelance
