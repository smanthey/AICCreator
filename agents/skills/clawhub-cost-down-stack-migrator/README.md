# Cost-Down Stack Migrator Skill

## Outcome
Deliver a repeatable workflow that solves: Teams churn from software due to cost and need lower-cost alternatives with migration plans.

## Target Users
small_business, freelance, agencies
